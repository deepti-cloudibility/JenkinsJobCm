node{
    ...
    stage('Upload') {
    nexusArtifactUploader artifacts: [[artifactId: 'channelmanager-discovery', classifier: 'debug', file: '/var/lib/jenkins/workspace/rdttdcr_master-.*/target/docker/channelmanager-discovery-0.0.1-SNAPSHOT.jar', type: 'jar', type: 'jar']], credentialsId: 'nexusAdmin', groupId: 'com.applicity.channelmanager', nexusUrl: '34.238.84.40:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'jenkins-artifacts', version: '0.0.1-SNAPSHOT'
    }
}
